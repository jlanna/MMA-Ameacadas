...
gantt
    ...
    Oficina de termos acordados :milestone, m3, after t9, 0d
    Compilação do Produto 1 (P4) :t10, after t9, 2w
    Levantamento dos mecanismos de publicação :t11, after t10, 2w
    Oficina de definição dos mecanismos de publicação :milestone, m4, after t11, 0d
    ...
    Reunião de apresentação dos produtos e fechamento :milestone, m5, after t13, 0d
